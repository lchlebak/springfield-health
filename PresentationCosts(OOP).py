# -*- coding: utf-8 -*-
"""
Created on Wed Oct 26 10:56:56 2016
...
def oop_cost_bar_graph(n=.835, old_family_type="Family", new_family_type="Family",
                    old_plan="VHP"):
...
# and out-of-pocket limits. The new premiums
# costs are then split between the employee and district according to a set
# m=.835 percentage. The district pays all out-of-pocket costs.
...
# 'old_plan' options: "VHP", "Plan JY"     
    ...
    frames = [m*family_year, (1-m)*family_year, OOP_limit]
    result = pd.concat(frames, axis=1)
    result.columns = ["District New Premium", "Employee New Premium",
                      "OOP Limit"]
    result.to_csv("OOPCostBarGraph"+old_family_type+new_family_type+old_plan+".csv")
