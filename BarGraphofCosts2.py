...
# 'old_plan' options: "VHP", "Comp", "Plan JY", "Old Plan JY"     
    ...
    # This correctly places the District Deductible amounts on the graph.        
    ax1.bar(bar_1[1:],
    ...
    # This correctly places the Employee Deductible amounts on the graph.        
    ax1.bar(bar_2[1:],
            # take the new deductibles
            (1-n)*deductible, 
            # set the width
    ...
    ax1.bar(bar_1[1:],
            ...
            # with District New Premium and Deductible below
            bottom = n*family_year + n*deductible,
            # with alpha 0.5
            alpha=0.5, 
            # with color in (R,G,B) format
            color=(.6, .4, .4))
    ...
    ax1.bar(bar_2[1:],
            ...
            # with Employee New Premium and Deductible below
            bottom = (1-n)*family_year + (1-n)*deductible,
            # with alpha 0.5
            alpha=0.5, 
            # with color in (R,G,B) format
            color=(.6, .6, .4))
